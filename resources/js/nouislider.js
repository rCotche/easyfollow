...
!(function (a) {
    ...
    function A(a, b, c) {
        ...
        if (
            ...
            throw new Error(
                "noUiSlider (" + Z + "): 'range' value isn't numeric."
            );
        c.xPct.push(d),
            c.xVal.push(b[0]),
            d
    ...
    function F(a, b) {
        if ("object" != typeof b || Array.isArray(b))
            throw new Error(
                "noUiSlider (" + Z + "): 'range' is not an object."
            );
    ...
    function G(a, b) {
        if (((b = j(b)), !Array.isArray(b) || !b.length))
            throw new Error(
                "noUiSlider (" + Z + "): 'start' option is incorrect."
            );
